...
export class ReaderService {
    ...
    searchBook(search: SearchDetails) {
        ...
        return this.http.get<Array<BookDetails>>(UrlConstants.SEARCHABOOK + "?title=" + search.title + "&authorName=" + search.authorName + "&publisher=" + search.publisher + "&fromDate=" + new Date(search.fromDate).getTime() + "&toDate=" + new Date(search.fromDate).getTime())
    }
}